...
app.get('/', function(req, res) {
    res.sendfile(__dirname + '/jeuStop1.2.2.html');
...
io.sockets.on('connection', function(socket) {
    ...
    socket.on('new user', function(data, callback) {
		...
		var letras = 'abcdefghilmnopqrstuvz';
		var rand = Math.floor(Math.random()*letras.length);
		letra=letras[rand];
		io.sockets.emit('lettre2', letras[rand]);
...
*/
function puntuacion (respuestas){
for (i=0;i<6;i++){
		if(respuestas[i]=='Rare') points[0]+=10;
		if(respuestas[i]=='Normal') points[0]+=5;

	}
	for (i=6;i<12;i++){
		if(respuestas[i]=='Rare') points[1]+=10;
		if(respuestas[i]=='Normal') points[1]+=5;
    ...
    socket.on('ARBITRE', function(r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12){
		...
		io.sockets.emit('ARBITRE2',r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12,finjeu);
		finjeu=false;
	var respuestas =[r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12];
	puntuacion(respuestas);
  ...
  /////Base de données////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		io.sockets.emit('FINTABLE3',us, result1,result2,result3,result4,result5,result6);
	...
	socket.on('FINTABLE',function(nick, r1,r2,r3,r4,r5,r6){
		io.sockets.emit('FINTABLE2',nick, r1,r2,r3,r4,r5,r6);
	});
	...
	socket.on('PointsFin', function(data){
		puntuacion(data);
	});
